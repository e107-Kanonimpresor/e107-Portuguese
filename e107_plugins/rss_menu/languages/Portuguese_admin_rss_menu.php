...
define("RSS_MENU_L6", "Nossos publicações do fórum");
define("RSS_MENU_L7", "Nossos publicações chatbox");
...
define("RSS_FP", "publicações do fórum");
define("RSS_FSP", "Publicação no fórum específico");
define("RSS_BUG", "Bugtracker");
define("RSS_FOR", "Fórum");
define("RSS_DL", "Transferências");
...
define("RSS_PLUGIN_LAN_11", "O feed rss da categoria de transferência:");
define("RSS_LAN_ADMINMENU_1", "Opções de RSS");
define("RSS_LAN_ADMINMENU_2", "Listagem");
define("RSS_LAN_ADMINMENU_4", "Importação");
define("RSS_LAN_ERROR_1", "Este não é um feed RSS válido. [Retornar à lista de feeds RSS]");
...
define("RSS_LAN_ERROR_3", "Ainda não há feeds RSS presentes[br]use o recurso de importação para importar feeds RSS disponíveis ou crie um feed RSS manualmente.");
...
define("RSS_LAN_ADMIN_15", "Seleccione links para marcá-los para importação...");
